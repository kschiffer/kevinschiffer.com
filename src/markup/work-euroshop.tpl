...
<main class="wrap work-showcase">
  <div class="grid project-title">
    <div class="grid__col grid__col--4-of-12 grid__col--m-1-of-2 grid__col--push-1-of-12">
      <h2 class="with-sub no-deco">tennagels at euroshop</h2>
      <span>
        Motion Graphics for Live Media<br>
        2014
      </span>
    </div>
  ...
  <div class="grid">
    ...
    <div class="grid__col grid__col--6-of-12 grid__col--m-3-of-4 grid__col--centered">
      <div class="description">
        <p>
          <b>A Live Media Design for <a href="http://tennagels.com">tennagels Medientechnik</a>'s booth at the Euroshop Retail Trade Fair.</b><br><br>
